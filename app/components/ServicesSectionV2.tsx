...
const services = [
  { name: "Développement Web FullStack", src: "magic-wand" },
  { name: "Apps Mobile React Native", src: "paint-bucket" },
  { name: "Backend Node.js / Express", src: "web" },
  { name: "Base de données PostgreSQL", src: "world" },
  { name: "Intégration API & IA", src: "planet" },
  { name: "UI/UX & Animations", src: "cube" },
]
