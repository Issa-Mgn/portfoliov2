...
const words: [string, string, string, string] = ["build", "create", "code", "ship"]
      ...
      <div className="xs:pb-32 mx-auto flex w-full max-w-6xl flex-col gap-12 px-5.5 pt-12 pb-24 text-white sm:pb-40 md:gap-16 md:px-11 md:pt-16 lg:pb-54">
        <div className="flex flex-col gap-8 md:gap-12">
          <H2 className="text-5xl leading-12 text-white md:text-6xl md:leading-14">
            ...
            <br />
            <span className="text-gray-500">quelque chose ensemble.</span>
          </H2>
          <ul className="flex flex-col justify-between gap-5.5 border-b border-gray-500 pb-6 text-sm md:flex-row md:items-center md:gap-8">
            <li className="flex flex-col gap-1 md:gap-2">
              ...
              <Link href="mailto:miganissa334@gmail.com" className="w-fit text-sm transition-colors duration-200 hover:text-gray-300">
                miganissa334@gmail.com
              </Link>
            </li>
            <li className="flex flex-col gap-1 md:gap-2">
              <span className="text-gray-500">WhatsApp</span>
              <Link href="https://wa.me/2290156103458" className="w-fit text-sm transition-colors duration-200 hover:text-gray-300">
                +229 01 56 10 34 58
              </Link>
            </li>
