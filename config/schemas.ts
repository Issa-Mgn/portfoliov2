...
const projectsData: ProjectItem[] = [
  {
    name: "Lotus Business",
    url: SITE_SLUGS.projectLinks.lotusbusiness,
    date: "2024-09-01",
    description: "App mobile offline-first de gestion commerciale pour petits commerçants béninois",
    type: "SoftwareApplication",
  },
  {
    name: "WritedIn",
    url: SITE_SLUGS.projectLinks.writedin,
    date: "2024-08-01",
    description: "Plateforme web de création de contenu social assistée par IA",
    type: "WebApplication",
  },
  {
    name: "Mike",
    url: SITE_SLUGS.projectLinks.mike,
    date: "2024-06-01",
    description: "Analyseur de conversations WhatsApp avec génération de portraits IA (Groq/Mistral)",
    type: "SoftwareApplication",
  },
  {
    name: "Okaz",
    url: SITE_SLUGS.projectLinks.okaz,
    date: "2024-04-01",
    description: "App de covoiturage React Native avec Mapbox et géolocalisation temps réel",
    type: "SoftwareApplication",
  },
  {
    name: "Le Focus",
    url: externalLinks.lefocus,
    date: "2024-03-01",
    description: "Site d'actualités béninois React/Vite + Express/Supabase",
    type: "WebSite",
  },
  {
    name: "GenerateMyCV",
    url: externalLinks.generatemycv,
    date: "2024-02-01",
    description: "Générateur de CV en ligne avec export PDF",
    type: "WebApplication",
  },
]
  ...
  "@graph": [
    {
      ...
      url: SITE,
      logo: { "@id": `${SITE}#logo` },
      sameAs: [SITE_NAP.profiles.github],
      contactPoint: [
        {
          "@type": "ContactPoint",
          contactType: "Hiring",
    ...
    },
    {
      ...
      "@id": `${SITE}#website`,
      url: SITE,
      name: "Issa MIGAN - Portfolio Développeur FullStack",
      publisher: { "@id": `${SITE}#org` },
      inLanguage: "fr",
    },
